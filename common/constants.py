...
# =======================LLM Module==========================
#LLM_MODULE_MODEL_PATH = '/root/autodl-tmp/chaomao/base_model/Baichuan2-7B-Chat'
LLM_MODULE_MODEL_PATH = '/hy-tmp/autodl-tmp/chaomao/finetune/llm_code/output/baichuan2-sft-1e5-1123-1806/final'
